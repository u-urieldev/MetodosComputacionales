...
(define (average lst)
  #|We use the funcion previosly define in exercice 11. We also implemented the function mean for exercise 17 (standar-deviation), which is also the average, but that function is made with let|#
